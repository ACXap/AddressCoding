...
{
    public class ChdRepository : IBDRepository
    {
        private const string ARGUMENT_CANNOT_NULL = "cannot be null";
        private const string TABLE_HOUSE = "edw_ods.t_000148_ent_as_house";
        private const string TABLE_ADDRESS = "edw_ods.t_000148_ent_as_addrobj";
